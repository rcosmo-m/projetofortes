document.addEventListener("DOMContentLoaded", () => {
  ...
  tabs.forEach((tab) => {
    tab.addEventListener("click", function () {
      ...
      // Hide all tab panes
      const tabPanes = this.parentElement.nextElementSibling.querySelectorAll(".tab-pane")
  ...
  viewProfileBtns.forEach((btn) => {
    btn.addEventListener("click", () => {
      // Hide current page
      document.getElementById("instituicao-empresas").classList.remove("active")

      // Show profile page
      document.getElementById("instituicao-empresa-profile").classList.add("active")
    })
  })
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.querySelectorAll(".btn-primary, .btn-secondary").forEach((button) => {
    button.addEventListener("click", function (e) {
      ...
      if (this.id === "logout-btn" || this.id === "logout-btn-empresa") return
  ...
  document.querySelectorAll(".btn-primary, .btn-secondary, .sidebar-nav ul li").forEach((element) => {
